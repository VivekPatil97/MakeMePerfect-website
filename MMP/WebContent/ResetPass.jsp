	...
	<div class="row">
		<div class="col-md-12">
			<div class="herotext">
				...
				WELCOME	${name} you are about to change your password
				</p>
			</div>
		</div>
	</div>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="maintitle">
					...
					<p class="lead">
						to change password you must know your old password.
					</p>
				</div>
				<div class="service-box wow zoomIn" data-wow-duration="1.5s" data-wow-delay="0.1s">
				<form id="login" method="post" action="ChgPass"  class="text-left">
					<fieldset>
					<div class="row error"><p>${error}</p>
						...
						<div class="row">
							<div class="col-md-6 wow fadeIn animated animated" data-wow-delay="0.1s" data-wow-duration="2s" style="margin: auto;">
								...
								<input type="text" name="username" id="username" size="30" placeholder="   e.g:vivekpatil/vivekpatil340440@gmail.com" required/>
							</div>
						</div>
						<div class="row">
							<div class="col-md-6 wow fadeIn animated" data-wow-delay="0.3s" data-wow-duration="2s">
								...
								<input type="password" name="oldpassword" id="oldpassword" size="30" placeholder="  Old password " required/>
							</div>
						</div>
						<div class="row">
							<div class="col-md-6 wow fadeIn animated" data-wow-delay="0.3s" data-wow-duration="2s">
								<label for="newpassword">New Password<span class="required">*</span></label>
								<input type="password" name="newpassword" id="newpassword" size="30" placeholder="  enter new password" required/>
							</div>
							<div class="col-md-6 wow fadeIn animated" data-wow-delay="0.3s" data-wow-duration="2s">
								<label for="repassword">Re-enter Password<span class="required">*</span></label>
								<input type="password" name="repassword" id="repassword" size="30" placeholder="  re-enter password here" required/>
							</div>
						</div>
						<div class="row">
